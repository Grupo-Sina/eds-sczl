  ...
  return (
    <div className="z-20 p-4 w-[610px] desktop:w-[830px]">
      <h1>
        ...
        <span className="text-white font-black font-heading text-7xl desktop:text-[106px] desktop:leading-[106px]">
          O
        </span>
        ...
        <span className="text-white font-bold font-heading text-8xl desktop:text-[145px] desktop:leading-[108px]">
          E
        </span>
        <span className="text-white font-bold font-heading text-8xl desktop:text-[145px] desktop:leading-[108px]">
          S
      ...
      <Button radius="full" className="bg-[#00E46F] font-heading text-[#003B9C] text-[16px] mt-4 desktop:mt-8 font-extrabold leading-5 text-center py-3 px-8 desktop:text-[24px] desktop:font-extrabold desktop:leading-[29px] desktop:py-6 desktop:px-11">PÁGINA PRINCIPAL</Button>
    </div>
  );
}
