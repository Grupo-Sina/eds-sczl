  ...
  return (
    <div className="w-[100%] mx-[28px] mb-4 md:mb-0 z-20 max-w-[935px] md:p-4 md:w-[610px] desktop:w-[800px]">
      ...
      <h1 className="text-center md:p-0">
        <span className="text-[55px] font-heading text-white sm:text-7xl font-bold desktop:text-[101px] desktop:leading-[109px]">
          Q
        </span>
        ...
        <span className="text-[55px] font-heading text-white font-black sm:text-7xl desktop:text-[101px] desktop:leading-[109px]">
          A
        </span>
        <span className="text-[55px] font-heading text-white font-bold sm:text-7xl desktop:text-[101px] desktop:leading-[109px]">
          L
        </span>
      ...
      <h1 className="text-center p-1 md:p-0">
        ...
        <span className="text-[64px] font-heading text-white font-black sm:text-8xl desktop:text-[118px] desktop:leading-[118px]">
          C
        </span>
        <span className="text-[64px] font-heading text-white font-bold sm:text-8xl desktop:text-[118px] desktop:leading-[118px]">
          A
      ...
      <h1 className="text-center py-3">
        ...
        <span className="text-[44px] font-heading text-white font-black sm:text-6xl desktop:text-[80px] desktop:leading-[80px]">
          U
        </span>
