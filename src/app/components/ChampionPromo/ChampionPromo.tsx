  ...
  return (
    <div className="px-12 md:px-0 w-screen md:w-full mt-8 md:mt-0">
      <h1 className="text-center md:text-left">
        <span className="text-[52px] text-white font-headingBold md:text-[80px]">
          O
        </span>
        <span className="text-[52px] text-white font-heading md:text-[80px]">
          {' '}
        </span>
        <span className="text-[52px] text-white font-headingBold md:text-[80px]">
          C
        </span>
        <span className="text-[52px] text-white font-headingLight md:text-[80px]">
          E
        </span>
        <span className="text-[52px] text-white font-headingThin md:text-[80px]">
          L
        </span>
        <span className="text-[52px] text-white font-headingExtraBold md:text-[80px]">
          E
        </span>
        <span className="text-[52px] text-white font-headingBold md:text-[80px]">
          S
        </span>
        <span className="text-[52px] text-white font-headingHeavy md:text-[80px]">
          T
        </span>
        <span className="text-[52px] text-white font-headingThin md:text-[80px]">
          E
      ...
      />
      <h1 className="text-center md:text-left">
        <span className="text-[32px] text-white lg:text-[48px] font-headingBold">
          C
        </span>
        <span className="text-[32px] text-white lg:text-[48px] font-heading">
          O
        </span>
        <span className="text-[32px] text-white lg:text-[48px] font-headingExtraBold">
          N
        </span>
        <span className="text-[32px] text-white lg:text-[48px] font-heading">
          F
        </span>
        <span className="text-[32px] text-white lg:text-[48px] font-headingLight">
          I
        </span>
        <span className="text-[32px] text-white lg:text-[48px] font-headingBold">
          R
        ...
        <span className="text-[32px] text-white lg:text-[48px] font-headingHeavy">
          O
        </span>
        <span className="text-[32px] text-white lg:text-[48px] font-heading">
          {' '}
