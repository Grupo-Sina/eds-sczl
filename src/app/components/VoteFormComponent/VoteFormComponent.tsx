...
export default function VoteFormComponent() {
  ...
  return (
    <form className="w-[650px] bg-[#0F1768] rounded-2xl p-12 text-white z-20">
      ...
      <Button
        ...
        className="bg-[#00E46F] text-[#003B9C] font-heading w-full mt-6 mb-6 py-3 px-8"
      >
        VOTAR
      </Button>
      ...
      <div className="flex space-x-4 items-center">
        ...
        <Button
          ...
          radius="full"
          variant="bordered"
          className="text-[#00E46F] font-heading border-[#00E46F] py-3 px-8"
        >
          VER REGRAS
        </Button>
        <Modal
